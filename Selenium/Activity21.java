...
public class Activity21 {
    public static void main(String[] args) {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div/main/div/div/div/div/button"))).click();
        wait.until(ExpectedConditions.numberOfWindowsToBe(2));
        System.out.println("Current windows: " + driver.getWindowHandles());
